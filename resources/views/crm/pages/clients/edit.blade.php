                        ...
                        <div>
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="vat" value="{{ $client->vat }}"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="zip" value="{{ $client->zip }}"
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="contact_name"
                                    value="{{ $client->contact_name }}" placeholder="Enter Contact's Name">
                            </div>
                            <div class="form-group">
                                <label for="contact_email">Contact Email address</label>
                                <input type="email" class="form-control" id="contact_email"
                                    value="{{ $client->contact_email }}" placeholder="Enter Contact's Email">
                            </div>
                            <div class="form-group">
                                <label for="contact_phone">Contact Phone Number</label>
                                <input type="text" class="form-control" id="contact_phone"
                                    value="{{ $client->contact_phone_number }}" placeholder="Enter Contact's Phone Number">
                            </div>
                        </div>
                        <!-- /.card-body -->
...
@section('scripts')
    <script>
        function createClient() {
            ...
            put("{{ route('clients.update', $client) }}", data, "submit-button", undefined, "{{ url()->previous() }}")
        }
    </script>
@endsection
