                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">Clients Deleted by <a
                                ...
                                <form method="GET" class="input-group input-group-sm" style="width: 270px;">
                                    ...
                                    <div class="input-group-append">
                                        ...
                                        @if (isset(request()->search))
                                            <a href="{{ route('users.relations.clients.deleted', $user) }}" class="btn btn-primary">
                                                All
                                            </a>
                                        @endif
                                    </div>
                        ...
                        <div class="card-body p-0">
                            <table class="table table-striped table-hover">
                                ...
                                <tbody>
                                    ...
                                    @empty
                                        <tr>
                                            <td colspan="8" style="text-align: center">{{$user->name}} hasn't deleted any clients</td>
                                        </tr>
                                    @endforelse
                                </tbody>
                            </table>
